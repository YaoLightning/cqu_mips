...
#
# Script generated by Vivado on Fri Jan 03 15:17:32 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ram_axi4.sh
...
#
# Usage        : ram_axi4.sh
#                ram_axi4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_axi4.sh [-reset_run]
#                ram_axi4.sh [-reset_log]
#                ram_axi4.sh [-help]
#
...
#                script (type 'ram_axi4.sh -help' for more information).
#
...
# script info
echo -e "ram_axi4.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_axi4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_axi4 xil_defaultlib.glbl -o ram_axi4_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_axi4_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/napbad/Project/cqu_mips/proj/cqu_mips.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ram_axi4_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_axi4_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_axi4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_axi4.sh [-help]\n\
Usage: ram_axi4.sh [-step]\n\
Usage: ram_axi4.sh [-lib_map_path]\n\
Usage: ram_axi4.sh [-reset_run]\n\
Usage: ram_axi4.sh [-reset_log]\n\
Usage: ram_axi4.sh [-keep_index]\n\
Usage: ram_axi4.sh [-noclean_files]\n\n\
