...
#
# Script generated by Vivado on Fri Jan 03 16:51:38 CST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ram_easy.sh
...
#
# Usage        : ram_easy.sh
#                ram_easy.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_easy.sh [-reset_run]
#                ram_easy.sh [-reset_log]
#                ram_easy.sh [-help]
#
...
# script info
echo -e "ram_easy.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_easy.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ram_easy xil_defaultlib.ram_easy xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ram_easy -key {Behavioral:sim_1:Functional:ram_easy} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ram_easy.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_easy.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_easy.sh [-help]\n\
Usage: ram_easy.sh [-step]\n\
Usage: ram_easy.sh [-lib_map_path]\n\
Usage: ram_easy.sh [-reset_run]\n\
Usage: ram_easy.sh [-reset_log]\n\
Usage: ram_easy.sh [-keep_index]\n\
Usage: ram_easy.sh [-noclean_files]\n\n\
